<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registro.aspx.cs" Inherits="Control_de_Gastos.Registro" %>
...
<body>
  ...
  <div class="container">
    ...
    <label for="psw"><b>Nueva Clave</b></label>
      ...
      <asp:Button ID="Bingresar" class="button2" runat="server" Text="Salvar">
